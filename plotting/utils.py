...
def generate_theta_plots_1_2_3(base_path: str, timestamp: str, ax):
    ...
    max_vals_4 = plotting_df[
        (plotting_df["step"] == max_steps.loc[("Nx12", "DRO"), "step"])
...
def generate_theta_plots_4_5_6(base_path: str, timestamp: str, ax):
    ...
    max_vals_1 = plotting_df[
        (plotting_df["step"] == max_steps.loc["count_minus", "step"])
        & (plotting_df["restriction_type"] == "count_minus")
    ]["max_bound"]
    max_vals_2 = plotting_df[
        (plotting_df["step"] == max_steps.loc["count", "step"])
        & (plotting_df["restriction_type"] == "count")
    ]["max_bound"]
    max_vals_3 = plotting_df[
        (plotting_df["step"] == max_steps.loc["count_plus", "step"])
...
def generate_cov_plots(base_path: str, timestamp: str, ax):
    ...
    max_vals_cov = plotting_df[
        (plotting_df["step"] == max_steps.loc["cov_positive", "step"])
...
def generate_theta_plots_1_2_regression(base_path: str, timestamp: str, ax):
    ...
    true_coef = plotting_df["true_coef"].mean()
    ...
    ax.fill_between(
        [min_x, 2, max_x],
        [min_empirical_coef] * 3,
        [max_empirical_coef] * 3,
        color="olive",
        alpha=0.2,
        label="Naive estimator",
        hatch="//",
...
def generate_theta_plots_3_4_regression(base_path: str, timestamp: str, ax):
    ...
    max_vals_1 = plotting_df[
        (plotting_df["step"] == 1499) & (plotting_df["restriction_type"] == "count")
    ]["max_bound"]
    max_vals_2 = plotting_df[
        (plotting_df["step"] == 1499)
        & (plotting_df["restriction_type"] == "count_plus")
    ...
    ax.set_xticks([1, 2])
    ax.set_xticklabels(["Experiment 4", "Experiment 5"])
